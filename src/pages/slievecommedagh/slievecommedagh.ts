...
addGeofence(map) {
  ...
  //geofence for reaching the top of SLieve Commedagh
  let fence = [{
    id: 'commedagh', //any unique ID
    latitude: 54.18885,  //center of geofence radius
    longitude: -5.93858,
    radius: 100, //radius to edge of geofence in meters
    transitionType: 1, //triggers when geofence is entered
    notification: { //notification settings
      id: 1,
      title: 'Top of Slieve Commedagh!',
      text: 'You Made it to the Top of Slieve Commedagh!',
      openAppOnClick: true //open app when notification is tapped
    }
  },
  //geofence for reaching the Slieve Commedagh Tower
  {
    id: 'tower', //any unique ID
    latitude: 54.18724, //center of geofence radius
    longitude: -5.94174,
    radius: 100, //radius to edge of geofence in meters
    transitionType: 1, //triggers when geofence is entered
    notification: {
      title: 'Slieve Commedagh Tower',
      text: 'Tower at the top of Slieve Commedagh!',
      openAppOnClick: true
    }
  }
  ]
